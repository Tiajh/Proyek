...
<!-- Hero Section -->
    <div class="container mx-auto px-4 mt-6">
        <div class="bg-green-100 shadow-md p-6 rounded-lg text-center">
            ...
            <button class="mt-6 inline-flex items-center bg-green-700 text-white px-6 py-3 rounded-lg hover:bg-green-800 transition duration-300">
...
<!-- Mengapa Pengelolaan Itu Penting? -->
    <div class="container mx-auto px-4 mt-10">
        <section class="bg-white shadow-md p-6 rounded-lg">
            <h2 class="text-2xl font-semibold text-green-700 mb-3">Mengapa Pengelolaan Itu Penting?</h2>
...
<div class="container mx-auto px-4 mt-10">
    <section class="bg-white shadow-md p-6 rounded-lg text-center">
        ...
        <button class="bg-green-700 text-white px-6 py-3 rounded-lg hover:bg-green-600 transition duration-300">
            Daftar Sekarang
        </button>
    </section>
</div>
